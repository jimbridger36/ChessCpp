...
#ifndef __PYX_HAVE__Wchess
#define __PYX_HAVE__Wchess
...
#endif /* !__PYX_HAVE_API__Wchess */

/* WARNING: the interface of the module init function changed in CPython 3.5. */
/* It now returns a PyModuleDef instance instead of a PyModule instance. */

#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initWchess(void);
#else
PyMODINIT_FUNC PyInit_Wchess(void);
#endif

#endif /* !__PYX_HAVE__Wchess */
