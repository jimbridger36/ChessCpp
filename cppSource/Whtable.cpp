...
#define nullDepth 0
    ...
    */
    ...
    void printFree(char* str) {
     ...
     bool inline individualEntry::isNull(char type) {
    ...
    void Entry::setEval(int depth, int eval, int boundFlag) {
    ...
    */
    ...
    HT::HT(char file[fileCharLength], int readReps) {
        int bytes;
        struct stat results;
        stat(file, &results);
    ...
    void HT::writeToFile(char file[fileCharLength], int writeRepetitions) {
    ...
    void HT::readIndexesFromFile(char file[fileCharLength]) {
    ...
    void HT::readFromFile(char file[fileCharLength], bool readRepetitions) {
    ...
    bool HT::check(ulong key, bool blackToPlay, int depth, int& alpha, int& beta, int& eval, Move& bestMove) {
        Entry entry = map[key];
        char wanted = 1;
    ...
    void HT::setEntry(ulong key, Entry val) {
        map[key] = val;
    }
